...
se for valores iguais, retornar que o segundo parametro é maior que o primeiro.
...
function compararNumero (parametro1, parametro2){
    if(parametro1 > parametro2){
        ...
        return `O maior número entre ${parametro2} e ${parametro1} é o ${parametro2}`
...
let obterResultado = compararNumero(100,20)
